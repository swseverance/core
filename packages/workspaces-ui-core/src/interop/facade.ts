...
export class GlueFacade {
    ...
    private async handleAddContainer(operationArguments: AddContainerArguments): Promise<AddItemResult> {
        ...
        console.log("FACDE 0", JSON.stringify(operationArguments.definition));
        ...
        console.log("FACDE 1", JSON.stringify(rendererFriendlyConfig));
        console.log("FACDE 2", JSON.stringify(operationArguments.definition));
