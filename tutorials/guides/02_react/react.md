...
Create the `<ChannelWidgetSelector />` component in the `return` statement. Pass the `channelNamesAndColors`, `onChannelSelected` and `onDefaultChannelSelected` as props to it:
